...
const Body = () => {
    return (
        ...
        <div className="flex items-center justify-center lg:flex-1 lg:order-2 lg:justify-end">
            ...
            <img src="./assets/Purple-Shape.svg" alt='3rd' className='absolute -rotate-[15deg] h-64 md:72 lg:h-[400px]'/>
        ...
        <p className='font-lato text-gray-400'>With Hostar , get your website up and running in no less than 5 minutes with the most competitive pricing packages available online</p>
